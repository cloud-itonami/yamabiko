(ns yamabiko.cells.social-post.state-machine
  "Phase state machine for the 山彦 — High-Speed Rail Manufacturing social_post cell — the publication membrane that
